...
class LWDETR(nn.Module):
    ...
    def __init__(
        ...
        hbs_foreground_kernel_size: int = 3,
    ):
        ...
        self.hbs = (
            HBS(
                ...
                foreground_kernel_size=hbs_foreground_kernel_size,
            )
            if hbs_enabled
            else None
        )
    ...
    def _forward_from_backbone_features(
        ...
        Returns:
            RF-DETR prediction dictionary for one feature branch.
        """
...
def build_model(args: "BuilderArgs"):
    ...
    model = LWDETR(
        ...
        hbs_foreground_kernel_size=getattr(args, "hbs_foreground_kernel_size", 3),
        hbs_kernel_sizes=[
