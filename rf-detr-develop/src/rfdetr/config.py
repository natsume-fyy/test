...
class ModelConfig(BaseConfig):
    ...
    hbs_foreground_scale: float = Field(default=0.1, ge=0)
    hbs_foreground_kernel_size: int = Field(default=3, ge=1)
    ...
    def _validate_hbs_task(self) -> "ModelConfig":
        ...
        if self.hbs_foreground_kernel_size % 2 == 0:
            raise ValueError("hbs_foreground_kernel_size must be odd.")
        return self
